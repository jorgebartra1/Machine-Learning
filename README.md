...
## Below are some samples of the results obtained using Pre-Trained Images given by UDACITY
...
## Below are some samples of the results obtained using my own image library
